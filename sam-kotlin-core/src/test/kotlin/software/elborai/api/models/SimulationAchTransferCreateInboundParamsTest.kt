...
import software.elborai.api.models.SimulationAchTransferCreateInboundParams.SimulationAchTransferCreateInboundBody
...
class SimulationAchTransferCreateInboundParamsTest {
    ...
    @Test
    fun getBody() {
      val params = SimulationAchTransferCreateInboundParams.builder()
          .accountNumberId("account_number_id")
          .amount(123L)
          .companyDescriptiveDate("x")
          .companyDiscretionaryData("x")
