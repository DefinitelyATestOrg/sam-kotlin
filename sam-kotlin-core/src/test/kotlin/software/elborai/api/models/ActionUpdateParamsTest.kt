...
class ActionUpdateParamsTest {
    ...
    fun createActionUpdateParams() {
        ActionUpdateParams.builder()
            ...
            .actionSetId("string")
            .agentId("string")
            .createdBy(ActionUpdateParams.CreatedBy.builder().id("string").name("string").build())
            .description("string")
            .errorMessage("string")
            ...
            .updatedBy(ActionUpdateParams.UpdatedBy.builder().id("string").name("string").build())
            .build()
    }
    ...
    fun getBody() {
        ...
        assertThat(body.createdBy())
            .isEqualTo(ActionUpdateParams.CreatedBy.builder().id("string").name("string").build())
        ...
        assertThat(body.updatedBy())
            .isEqualTo(ActionUpdateParams.UpdatedBy.builder().id("string").name("string").build())
    }

    @Test
    fun getBodyWithoutOptionalFields() {
        val params = ActionUpdateParams.builder().actionId("string").build()
        val body = params.getBody()
        assertThat(body).isNotNull
    }
