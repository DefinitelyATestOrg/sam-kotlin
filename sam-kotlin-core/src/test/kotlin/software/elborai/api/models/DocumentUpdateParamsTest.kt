...
class DocumentUpdateParamsTest {
    ...
    fun createDocumentUpdateParams() {
        DocumentUpdateParams.builder()
            ...
            .createdBy(DocumentUpdateParams.CreatedBy.builder().id("string").name("string").build())
            .externalLookupKey("string")
            .languageCode(
                DocumentUpdateParams.LanguageCode.builder().code("string").detected(true).build()
            )
            ...
            .text("string")
            .title("string")
            .updatedBy(DocumentUpdateParams.UpdatedBy.builder().id("string").name("string").build())
            .build()
    }
    ...
    fun getBody() {
        ...
        assertThat(body.createdBy())
            .isEqualTo(DocumentUpdateParams.CreatedBy.builder().id("string").name("string").build())
        assertThat(body.externalLookupKey()).isEqualTo("string")
        assertThat(body.languageCode())
            .isEqualTo(
                DocumentUpdateParams.LanguageCode.builder().code("string").detected(true).build()
            )
        assertThat(body.processingVersion()).isEqualTo(123L)
        assertThat(body.sourceAuthor()).isEqualTo("string")
        assertThat(body.sourceCreatedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(body.sourceUpdatedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(body.updatedBy())
            .isEqualTo(DocumentUpdateParams.UpdatedBy.builder().id("string").name("string").build())
    }

    @Test
    fun getBodyWithoutOptionalFields() {
        val params = DocumentUpdateParams.builder().docId("string").build()
        val body = params.getBody()
        assertThat(body).isNotNull
    }
