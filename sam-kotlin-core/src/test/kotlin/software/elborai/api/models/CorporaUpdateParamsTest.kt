...
class CorporaUpdateParamsTest {
    ...
    fun createCorporaUpdateParams() {
        CorporaUpdateParams.builder()
            ...
            .createdBy(CorporaUpdateParams.CreatedBy.builder().id("string").name("string").build())
            ...
            .updatedBy(CorporaUpdateParams.UpdatedBy.builder().id("string").name("string").build())
    ...
    fun getBody() {
        ...
        assertThat(body.createdBy())
            .isEqualTo(CorporaUpdateParams.CreatedBy.builder().id("string").name("string").build())
        assertThat(body.excludeLastUpdatedBefore())
        ...
        assertThat(body.updatedBy())
            .isEqualTo(CorporaUpdateParams.UpdatedBy.builder().id("string").name("string").build())
