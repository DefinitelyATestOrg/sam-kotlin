...
import software.elborai.api.models.EntityBeneficialOwnerCreateParams.EntityBeneficialOwnerCreateBody
...
class EntityBeneficialOwnerCreateParamsTest {
    ...
    @Test
    fun getBody() {
      val params = EntityBeneficialOwnerCreateParams.builder()
          .beneficialOwner(EntityBeneficialOwnerCreateParams.BeneficialOwner.builder()
              .individual(EntityBeneficialOwnerCreateParams.BeneficialOwner.Individual.builder()
                  .address(EntityBeneficialOwnerCreateParams.BeneficialOwner.Individual.Address.builder()
                      .city("x")
      ...
      assertThat(body.beneficialOwner()).isEqualTo(EntityBeneficialOwnerCreateParams.BeneficialOwner.builder()
          .individual(EntityBeneficialOwnerCreateParams.BeneficialOwner.Individual.builder()
              .address(EntityBeneficialOwnerCreateParams.BeneficialOwner.Individual.Address.builder()
                  .city("x")
                  .line1("x")
