...
import software.elborai.api.services.blocking.CorporaService
...
class CorporaServiceTest {
    ...
    fun callRetrieve(wmRuntimeInfo: WireMockRuntimeInfo) {
      ...
      val response = corporaService.retrieve(CorporaRetrieveParams.builder()
          .corpusId("string")
          .build())
      println(response)
    ...
    fun callUpdate(wmRuntimeInfo: WireMockRuntimeInfo) {
      ...
      val corporaService = client.corpora()
      val response = corporaService.update(CorporaUpdateParams.builder()
          .corpusId("string")
          .agentId("string")
          .name("string")
          .active(true)
    ...
    fun callDelete() {
      val client = SamOkHttpClient.builder()
          ...
          .build()
      val corporaService = client.corpora()
      corporaService.delete(CorporaDeleteParams.builder()
          .corpusId("string")
          .build())
    }
}
