...
import software.elborai.api.services.blocking.AgentService
...
class AgentServiceTest {
    ...
    fun callRetrieve(wmRuntimeInfo: WireMockRuntimeInfo) {
      ...
      val response = agentService.retrieve(AgentRetrieveParams.builder()
          .id("string")
          .build())
      println(response)
    ...
    fun callUpdate(wmRuntimeInfo: WireMockRuntimeInfo) {
      ...
      val agentService = client.agents()
      val response = agentService.update(AgentUpdateParams.builder()
          .id("string")
    ...
    fun callDelete() {
      val client = SamOkHttpClient.builder()
          ...
          .build()
      val agentService = client.agents()
      agentService.delete(AgentDeleteParams.builder()
          .id("string")
          .build())
    }
}
