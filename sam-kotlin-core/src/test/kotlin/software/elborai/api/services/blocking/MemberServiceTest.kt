...
import software.elborai.api.services.blocking.MemberService
...
class MemberServiceTest {
    ...
    fun callUpdate(wmRuntimeInfo: WireMockRuntimeInfo) {
      ...
      val response = memberService.update(MemberUpdateParams.builder()
          .memberId("string")
          .id("string")
          .email("string")
          .name("string")
    ...
    fun callDelete() {
      val client = SamOkHttpClient.builder()
          ...
          .build()
      val memberService = client.members()
      memberService.delete(MemberDeleteParams.builder()
          .memberId("string")
          .build())
    }
}
