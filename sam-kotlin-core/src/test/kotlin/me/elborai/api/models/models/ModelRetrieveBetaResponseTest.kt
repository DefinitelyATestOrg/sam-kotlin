...
class ModelRetrieveBetaResponseTest {

    @Test
    fun createModelRetrieveBetaResponse() {
      val modelRetrieveBetaResponse = ModelRetrieveBetaResponse.builder()
      ...
      assertThat(modelRetrieveBetaResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2025-02-19T00:00:00Z"))
