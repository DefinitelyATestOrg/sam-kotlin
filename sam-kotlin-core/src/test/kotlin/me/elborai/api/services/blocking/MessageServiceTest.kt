...
class MessageServiceTest {
    ...
    fun create() {
      ...
      val message = messageService.create(MessageCreateParams.builder()
    ...
    fun countTokens() {
      ...
      val response = messageService.countTokens(MessageCountTokensParams.builder()
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
    ...
    fun countTokensBeta() {
      ...
      val response = messageService.countTokensBeta(MessageCountTokensBetaParams.builder()
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
