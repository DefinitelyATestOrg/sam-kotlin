...
class MessageServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val message = messageServiceAsync.create(MessageCreateParams.builder()
    ...
    suspend fun countTokens() {
      ...
      val response = messageServiceAsync.countTokens(MessageCountTokensParams.builder()
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
    ...
    suspend fun countTokensBeta() {
      ...
      val response = messageServiceAsync.countTokensBeta(MessageCountTokensBetaParams.builder()
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
