...
class BatchServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val batch = batchServiceAsync.create(BatchCreateParams.builder()
    ...
    suspend fun retrieve() {
      ...
      val batch = batchServiceAsync.retrieve(BatchRetrieveParams.builder()
    ...
    suspend fun list() {
      ...
      val batch = batchServiceAsync.list(BatchListParams.builder()
          .afterId("after_id")
          .beforeId("before_id")
          .limit(1L)
          .addAnthropicBeta("string")
    ...
    suspend fun delete() {
      ...
      val batch = batchServiceAsync.delete(BatchDeleteParams.builder()
          .messageBatchId("message_batch_id")
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
    ...
    suspend fun cancel() {
      ...
      val response = batchServiceAsync.cancel(BatchCancelParams.builder()
          .messageBatchId("message_batch_id")
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
    ...
    suspend fun cancelBeta() {
      ...
      val response = batchServiceAsync.cancelBeta(BatchCancelBetaParams.builder()
          .messageBatchId("message_batch_id")
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
    ...
    suspend fun results() {
      ...
      val response = batchServiceAsync.results(BatchResultsParams.builder()
          .messageBatchId("message_batch_id")
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
    ...
    suspend fun resultsBeta() {
      ...
      val response = batchServiceAsync.resultsBeta(BatchResultsBetaParams.builder()
          .messageBatchId("message_batch_id")
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
