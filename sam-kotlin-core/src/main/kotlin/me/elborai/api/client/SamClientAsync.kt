...
/**
 * A client for interacting with the Sam REST API asynchronously. You can also
...
interface SamClientAsync {
    ...
    /**
     * A view of [SamClientAsync] that provides access to raw HTTP responses for each
     * method.
     */
