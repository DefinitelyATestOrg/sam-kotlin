...
class ModelServiceAsyncImpl internal constructor(
    ...
    override suspend fun retrieve(params: ModelRetrieveParams, requestOptions: RequestOptions): ModelRetrieveResponse =
        // get /v1/models/{model_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun list(params: ModelListParams, requestOptions: RequestOptions): ModelListResponse =
        // get /v1/models
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun retrieveBeta(params: ModelRetrieveBetaParams, requestOptions: RequestOptions): ModelRetrieveBetaResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun retrieve(params: ModelRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<ModelRetrieveResponse> {
        ...
        override suspend fun list(params: ModelListParams, requestOptions: RequestOptions): HttpResponseFor<ModelListResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override suspend fun retrieveBeta(params: ModelRetrieveBetaParams, requestOptions: RequestOptions): HttpResponseFor<ModelRetrieveBetaResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "models", params.getPathParam(0))
