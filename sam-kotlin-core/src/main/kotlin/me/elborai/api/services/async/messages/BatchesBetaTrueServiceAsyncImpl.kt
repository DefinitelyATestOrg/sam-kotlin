...
class BatchesBetaTrueServiceAsyncImpl internal constructor(
    ...
    override suspend fun create(params: BatchesBetaTrueCreateParams, requestOptions: RequestOptions): BatchesBetaTrueCreateResponse =
        // post /v1/messages/batches?beta=true
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun list(params: BatchesBetaTrueListParams, requestOptions: RequestOptions): BatchesBetaTrueListResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: BatchesBetaTrueCreateParams, requestOptions: RequestOptions): HttpResponseFor<BatchesBetaTrueCreateResponse> {
        ...
        override suspend fun list(params: BatchesBetaTrueListParams, requestOptions: RequestOptions): HttpResponseFor<BatchesBetaTrueListResponse> {
          val request = HttpRequest.builder()
