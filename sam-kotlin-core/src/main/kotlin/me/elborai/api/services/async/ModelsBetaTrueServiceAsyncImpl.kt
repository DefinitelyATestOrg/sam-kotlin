...
class ModelsBetaTrueServiceAsyncImpl internal constructor(
    ...
    override suspend fun list(params: ModelsBetaTrueListParams, requestOptions: RequestOptions): ModelsBetaTrueListResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun list(params: ModelsBetaTrueListParams, requestOptions: RequestOptions): HttpResponseFor<ModelsBetaTrueListResponse> {
