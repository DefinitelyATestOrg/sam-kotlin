  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Source private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
         ...
         */
        fun checkTransferStopPaymentRequest(): CheckTransferStopPaymentRequest? = checkTransferStopPaymentRequest.getNullable("check_transfer_stop_payment_request")
         ...
         */
        fun inboundInternationalAchTransfer(): InboundInternationalAchTransfer? = inboundInternationalAchTransfer.getNullable("inbound_international_ach_transfer")
         ...
         */
        fun inboundWireDrawdownPayment(): InboundWireDrawdownPayment? = inboundWireDrawdownPayment.getNullable("inbound_wire_drawdown_payment")
        ...
        class Category @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
            ...
            companion object {
                ...
                val CHECK_TRANSFER_STOP_PAYMENT_REQUEST = Category(JsonField.of("check_transfer_stop_payment_request"))
                ...
                val INBOUND_INTERNATIONAL_ACH_TRANSFER = Category(JsonField.of("inbound_international_ach_transfer"))
                ...
                val INBOUND_WIRE_DRAWDOWN_PAYMENT = Category(JsonField.of("inbound_wire_drawdown_payment"))
