...
class PetServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : PetServiceAsync {
    ...
    override suspend fun create(params: PetCreateParams, requestOptions: RequestOptions) {
    ...
    override suspend fun findByStatus(params: PetFindByStatusParams, requestOptions: RequestOptions): List<Pet> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
     ...
     * for testing.
     */
    override suspend fun findByTags(params: PetFindByTagsParams, requestOptions: RequestOptions): List<Pet> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
    ...
    /** uploads an image */
    override suspend fun uploadImage(params: PetUploadImageParams, requestOptions: RequestOptions): ApiResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
