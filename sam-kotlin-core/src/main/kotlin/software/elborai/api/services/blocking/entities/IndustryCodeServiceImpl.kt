...
class IndustryCodeServiceImpl constructor(private val clientOptions: ClientOptions, ) : IndustryCodeService {
    ...
    override fun create(params: EntityIndustryCodeCreateParams, requestOptions: RequestOptions): Entity {
