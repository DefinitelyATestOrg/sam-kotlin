...
class StoreServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : StoreServiceAsync {
     ...
     * generate exceptions.
     */
    override suspend fun retrieve(params: StoreRetrieveParams, requestOptions: RequestOptions): Order {
    ...
    override suspend fun createOrder(params: StoreCreateOrderParams, requestOptions: RequestOptions): Order {
      val request = HttpRequest.builder()
    ...
    override suspend fun inventory(params: StoreInventoryParams, requestOptions: RequestOptions): StoreInventoryResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
