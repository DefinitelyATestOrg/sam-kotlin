...
class SupplementalDocumentServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : SupplementalDocumentServiceAsync {
    ...
    override suspend fun create(params: EntitySupplementalDocumentCreateParams, requestOptions: RequestOptions): Entity {
    ...
    override suspend fun list(params: EntitySupplementalDocumentListParams, requestOptions: RequestOptions): EntitySupplementalDocumentListPageAsync {
      val request = HttpRequest.builder()
