...
class ChatServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ChatServiceAsync {
    ...
    override suspend fun retrieve(params: AgentConfigChatRetrieveParams, requestOptions: RequestOptions): BinaryResponseContent {
    ...
    override suspend fun update(params: AgentConfigChatUpdateParams, requestOptions: RequestOptions): BinaryResponseContent {
      val request = HttpRequest.builder()
