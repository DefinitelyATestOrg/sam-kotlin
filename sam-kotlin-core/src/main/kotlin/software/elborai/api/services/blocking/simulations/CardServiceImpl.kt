...
class CardServiceImpl constructor(private val clientOptions: ClientOptions, ) : CardService {
     ...
     */
    override fun authorize(params: SimulationCardAuthorizeParams, requestOptions: RequestOptions): CardAuthorizationSimulation {
     ...
     */
    override fun settlement(params: SimulationCardSettlementParams, requestOptions: RequestOptions): Transaction {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
