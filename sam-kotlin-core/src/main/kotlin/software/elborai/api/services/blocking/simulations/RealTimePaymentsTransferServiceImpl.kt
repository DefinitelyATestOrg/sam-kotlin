...
class RealTimePaymentsTransferServiceImpl constructor(private val clientOptions: ClientOptions, ) : RealTimePaymentsTransferService {
     ...
     */
    override fun createInbound(params: SimulationRealTimePaymentsTransferCreateInboundParams, requestOptions: RequestOptions): InboundRealTimePaymentsTransferSimulationResult {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
