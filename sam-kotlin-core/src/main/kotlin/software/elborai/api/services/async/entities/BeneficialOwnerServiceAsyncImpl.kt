...
class BeneficialOwnerServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : BeneficialOwnerServiceAsync {
    ...
    override suspend fun create(params: EntityBeneficialOwnerCreateParams, requestOptions: RequestOptions): Entity {
    ...
    override suspend fun archive(params: EntityBeneficialOwnerArchiveParams, requestOptions: RequestOptions): Entity {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override suspend fun updateAddress(params: EntityBeneficialOwnerUpdateAddressParams, requestOptions: RequestOptions): Entity {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
