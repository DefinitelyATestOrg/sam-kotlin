...
interface CardServiceAsync {
     ...
     */
    suspend fun authorize(params: SimulationCardAuthorizeParams, requestOptions: RequestOptions = RequestOptions.none()): CardAuthorizationSimulation
     ...
     */
    suspend fun settlement(params: SimulationCardSettlementParams, requestOptions: RequestOptions = RequestOptions.none()): Transaction
}
