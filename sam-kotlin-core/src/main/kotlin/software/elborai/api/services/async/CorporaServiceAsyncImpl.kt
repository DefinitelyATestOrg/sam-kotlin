...
class CorporaServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : CorporaServiceAsync {
    ...
    override suspend fun retrieve(params: CorporaRetrieveParams, requestOptions: RequestOptions): BinaryResponseContent {
    ...
    override suspend fun update(params: CorporaUpdateParams, requestOptions: RequestOptions): BinaryResponseContent {
      val request = HttpRequest.builder()
    ...
    override suspend fun delete(params: CorporaDeleteParams, requestOptions: RequestOptions) {
      val request = HttpRequest.builder()
