...
class SamClientAsyncImpl constructor(private val clientOptions: ClientOptions, ) : SamClientAsync {
    ...
    private val referenceSets: ReferenceSetServiceAsync by lazy { ReferenceSetServiceAsyncImpl(clientOptions) }

    private val referenceSessions: ReferenceSessionServiceAsync by lazy { ReferenceSessionServiceAsyncImpl(clientOptions) }
    ...
    private val actionSets: ActionSetServiceAsync by lazy { ActionSetServiceAsyncImpl(clientOptions) }
