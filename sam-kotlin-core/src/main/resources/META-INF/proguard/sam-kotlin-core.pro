...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class me.elborai.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class me.elborai.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class me.elborai.api.** {
    <init>(...);
