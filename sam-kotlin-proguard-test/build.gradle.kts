...
dependencies {
    testImplementation(project(":sam-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../sam-kotlin-core/src/main/resources/META-INF/proguard/sam-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../sam-kotlin-core/src/main/resources/META-INF/proguard/sam-kotlin-core.pro",
